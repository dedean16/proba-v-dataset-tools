#!/usr/bin/env python3
"""Configuration for collect script."""
...
cfg['ROI'] = ROI                    # Region Of Interest
...
# Since the corner coordinates can't be the same,
# this is added in the case of single points
